...
global firstos_command:function
global firstos_get_process_arguments:function
global firstos_exit:function
...
firstos_command:
    push ebp
    mov ebp, esp
    mov eax, 7; invoke system command system call
...
firstos_get_process_arguments:
    push ebp
    mov ebp, esp
    mov eax, 8; get process argument system call
    push dword[ebp + 8] ; variable arguments
    int 0x80
    add esp, 4
    pop ebp
