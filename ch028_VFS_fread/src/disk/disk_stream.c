...
int read_from_disk_stream(struct disk_stream* stream, void* output, int target_total_bytes_to_read) {
    ...
    int current_total_bytes_to_read = target_total_bytes_to_read > DISK_SECTOR_SIZE ? DISK_SECTOR_SIZE : target_total_bytes_to_read;
    ...
    if (target_total_bytes_to_read > DISK_SECTOR_SIZE) {
        result = read_from_disk_stream(stream, output, target_total_bytes_to_read - DISK_SECTOR_SIZE);
    }
