...
int map_binary(struct process* process) {
    ...
    map_page(process->task->page_directory, (void*) PROGRAM_VIRTUAL_ADDRESS, process->process_data, align_address(process->process_data + process->size), PAGING_IS_PRESENT | PAGING_IS_WRITABLE | PAGING_ACCESS_FROM_ALL);
