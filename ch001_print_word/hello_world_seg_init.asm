...
start:
    ; Clear interrupt. It will disable interrup. It make sure segment initialization progress won't be interrupted and cause unexpected result
    cli
    ...
    ; initializae stack segment. Note stack memory address decrease when pushing value to it(SP).
    mov ax, 0x00
